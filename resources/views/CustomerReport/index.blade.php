        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                ...
                <div class="card-header pb-0">
                    ...
                    <form action="{{url('searchCustomer')}}" method="POST" role="search" autocomplete="off">
                        @csrf
                            ...
                            <div class="col">
                                ...
                                <select name="Section" class="form-control select2" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($department as $section)
                                        <option value="{{ $section->id }}"> {{ $section->departmentName }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <table id="example" class="table key-buttons text-md-nowrap" style=" text-align: center">
                                ...
                                @foreach ($invoices as $invoice)
                                    <tr>
                                        ...
                                        <td><a
                                                href="{{ url('InvoicesDetails') }}/{{ $invoice->id }}">{{ $invoice->department->departmentName }}</a>
                                        </td>
