				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='invoicePaid') }}">الفواتير المدفوعه</a></li>
                                @endcan
                                @can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/' . $page='invoiceUnpaid') }}">الفواتير غير مدفوعه</a></li>
                                @endcan
                                @can('الفواتير المدفوعة جزئيا')
                            <li><a class="slide-item" href="{{ url('/' . $page='invoicePartialPaid') }}">الفواتير المدفوعه جزئيا</a></li>
                                @endcan
                                @can('ارشيف الفواتير')
                            <li><a class="slide-item" href="{{ url('/' . $page='archiveInvoice') }}">ارشيف الفاتوره</a></li>
                                @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
                        ...
                        @can('تقرير الفواتير')
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='invoiceReport') }}">تقارير فواتير</a></li>
                            @endcan
                            @can('تقرير العملاء')
							<li><a class="slide-item" href="{{ url('/' . $page='customerReport') }}">تقارير العملاء</a></li>
                            @endcan
						</ul>
					</li>
                    @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='users') }}">قائمه المستدمين</a></li>
                            @endcan
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            @can('الاقسام')
							<li><a class="slide-item" href="{{ url('/' . $page='department') }}">الاقسام</a></li>
                            @endcan
                            @can('المنتجات')
							<li><a class="slide-item" href="{{ url('/' . $page='product') }}">منتجات</a></li>
                                @endcan
						</ul>
					</li>
                    @endcan
